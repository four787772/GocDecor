 ...
 */
@WebServlet("/AddLightView")
public class AddLightView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.append("");
		out.append("<title>GocDecore - Thêm mới sản Phẩm</title>");
		...
		out.append("<i class=\"bi bi-menu-button-wide\"></i><span>Chiến lược</span><i class=\"bi bi-chevron-down ms-auto\"></i>");
		out.append("</a>");
		...
		out.append("<i class=\"bi bi-journal-text\"></i><span>Đối tác</span><i class=\"bi bi-chevron-down ms-auto\"></i>");
		out.append("</a>");
		...
		out.append("<i class=\"bi bi-layout-text-window-reverse\"></i><span>Sản Phẩm</span><i class=\"bi bi-chevron-down ms-auto\"></i>");
		out.append("</a>");
		...
		out.append("<h1>Thêm mới sản phẩm</h1>");
		out.append("<nav>");
		...
		out.append("");
		out.append("<form class=\"row g-3\" action=\"/GocDecore/AddLightView\" method=\"post\">");
...
//		        out.append("<input type=\"number\" class=\"form-control\" id=\"Light_id\" name=\"Light_id\" placeholder=\"\">");
//		    out.append("</div>");
		out.append("<div class=\"col-md-3\">");
		...
		out.append("<div class=\"col-md-9\">");
		out.append(
				"<input type=\"text\" class=\"form-control\" id=\"Light_name\" name=\"Light_name\" placeholder=\"\">");
		out.append("</div>");
		out.append("</div>");
		out.append("<!-- Giá -->");
		out.append("<div class=\"row mb-2\">");
		...
		out.append("<div class=\"row mb-2\">");
		out.append("<div class=\"col-md-3\">");
		out.append("<label for=\"Light_percen\" class=\"form-label\">Giảm giá %</label>");
		out.append("</div>");
		out.append("<div class=\"col-md-9\">");
		out.append(
				"<input type=\"number\" class=\"form-control\" id=\"Light_percen\" name=\"Light_percen\" placeholder=\"\">");
		out.append("</div>");
		out.append("</div>");
		...
		out.append("<div class=\"col-md-9\">");
		out.append(
				"<input type=\"text\" class=\"form-control\" id=\"Light_color\" name=\"Light_color\" placeholder=\"\">");
		out.append("</div>");
		out.append("</div>");
		...
		out.append("<div class=\"col-md-9\">");
		out.append(
				"<input type=\"text\" class=\"form-control\" id=\"Light_size\" name=\"Light_size\" placeholder=\"\">");
		out.append("</div>");
		out.append("</div>");
		...
		out.append("<option selected>Click để chọn tình trạng sản phẩm</option>");
		...
		out.append(
				"<button type=\"submit\" class=\"btn btn-danger me-3\" style=\"border-radius: 50px;\">Thêm mới</button>");
		out.append("<button type=\"reset\" class=\"btn btn-dark\" onclick=\"history.back()\" style=\"border-radius: 50px;\">Hủy</button>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String lightPercenStr = request.getParameter("Light_percen");
            ...
            int lightPercen = Integer.parseInt(lightPercenStr);
            ...
            boolean rs = lf.addLight(item);
            if (rs) {
                response.sendRedirect("/GocDecore/AdminLight?success1=true"); // Điều hướng đến trang quản lý sản phẩm sau khi thêm thành công
            } else {
