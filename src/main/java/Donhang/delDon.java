...
/**
 * Servlet implementation class delDon
 */
@WebServlet("/delDon")
public class delDon extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (result) {
            response.sendRedirect("/GocDecore/donhang?success2=true"); // Điều hướng đến trang Deal nếu xóa thành công
        } else {
